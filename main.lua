if IY_LOADED and not _G.IY_DEBUG == true then
 ...
 CMDs[#CMDs + 1] = {NAME = 'credits', DESC = 'All the credits for Infinite Yield Premium FE.'}
 ...
 CMDs[#CMDs + 1] = {NAME = 'antifollower', DESC = 'Tp to the void and then back (useful to kill people attached to you)'}
 ...
 CMDs[#CMDs + 1] = {NAME = 'spoofspeed / spoofws [num]', DESC = 'Spoofs your WalkSpeed on the Client (bypasses most anti-cheats)'}
 ...
 CMDs[#CMDs + 1] = {NAME = 'spoofjumppower / spoofjp [num]', DESC = 'Spoofs your JumpPower on the Client (bypasses most anti-cheats)'}
 ...
 task.spawn(function()
   local success, latestVersionInfo = pcall(function() 
      local versionJson = game:HttpGet('https://raw.githubusercontent.com/ryzsb/InfYieldPremium/refs/heads/main/version')
